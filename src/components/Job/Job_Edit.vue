      ...
      <v-col cols="12">
        <v-card max-width="1024px" class="mx-auto" ref="form" >
          ...
          <div class="pa-4">
            ...
            <!-- 제목 -->
            <div class="text-center mb-10"><h1>업무 수정하기</h1></div>
...
export default {
  ...
  created () {
    axios({
      ...
      .then(response => {
        this.singleLineIntro = response.data.data.job.singleLineIntro
        this.comOrIndi = response.data.data.job.comOrIndi
        this.companyName = response.data.data.job.companyName
        this.pic = response.data.data.job.pic
        this.phone = response.data.data.job.phone
        this.email = response.data.data.job.email
        this.jobType = response.data.data.job.jobType
        this.startDate = response.data.data.job.startDate
        this.endDate = response.data.data.job.endDate
        this.recruitDate = response.data.data.job.recruitDate
        this.numRecruit = response.data.data.job.numRecruit
        this.jobLocation = response.data.data.jobLocation
        this.salary = response.data.data.job.salary
        this.amount = response.data.data.job.amount
        this.isNego = response.data.data.job.isNego
        this.jobDescription = this.textareaBack(response.data.data.job.jobDescription)
      })
  },
  computed: {
    form () {
